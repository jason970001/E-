...
def imgs2imgs(src, dst, canvas_size, sample_count, sample_dir,label):
...
if __name__ == "__main__":
    ...
    if args.mode == 'font2font':
        ...
        imgs2imgs(args.src_imgs, args.dst_imgs, args.canvas_size, args.sample_count, args.sample_dir,args.label)
    else:
